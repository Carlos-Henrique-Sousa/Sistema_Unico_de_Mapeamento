...
class IAMapeamentoSala:
    ...
    def __init__(self, mapeamento: MapeamentoSala):
        ...
        self.linhas = mapeamento.linhas
        self.colunas = mapeamento.colunas
        self.tipo_agrupamento = mapeamento.tipo_agrupamento
        self.numero_pessoas_grupo = mapeamento.numero_pessoas_grupo
