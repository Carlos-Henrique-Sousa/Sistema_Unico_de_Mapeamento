...
const allStudents = ref<Student[]>([
  { id: '1', name: 'João Silva', position: { x: 0, y: 0 } },
  { id: '2', name: 'Maria Santos', visionIssues: true, position: { x: 0, y: 0 } },
  { id: '3', name: 'Pedro Costa', position: { x: 0, y: 0 } },
  { id: '4', name: 'Ana Lima', position: { x: 0, y: 0 } },
  { id: '5', name: 'Carlos Souza', position: { x: 0, y: 0 } }
]);
